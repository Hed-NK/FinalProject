...
bubble_chart = alt.Chart(filtered_df).mark_circle().encode(
    ...
    title='Bubble Chart of Recovered per Cases by continent and Population Size'
)
...
# Facet Grid 
fig_facet = px.scatter(filtered_df, x='cases', y='deaths', color='continent', facet_col='continent', title='Facet Grid of Deaths per Cases by Continent')
